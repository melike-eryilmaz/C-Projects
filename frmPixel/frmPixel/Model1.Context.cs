...
namespace frmPixel
{
    ...
    public partial class PixelDbEntities : DbContext
    {
        public PixelDbEntities()
            : base("name=PixelDbEntities")
        {
        }
        ...
        public virtual DbSet<DepartmentToPersonels> DepartmentToPersonels { get; set; }
        public virtual DbSet<EducationDetails> EducationDetails { get; set; }
        public virtual DbSet<Educations> Educations { get; set; }
        public virtual DbSet<EducationToStudents> EducationToStudents { get; set; }
