...
using ECommerceHome.Areas.Admin.Models;

namespace ECommerceHome.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,CategoryId,BrandId,Name,UnitPrice,İmageUrl,UnitInStock,IsNew,IsSale,RegisterDate,IsActive")] Products products)
        {
